  ...
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" size="450px" :title="`${drawerProps.title}用户`">
    ...
    >
      <el-form-item label="用户头像" prop="avatar">
        <upload-img v-model:image-url="drawerProps.row!.avatar" width="135px" height="135px" :file-size="3">
          <template #empty>
      ...
      <el-form-item label="用户照片" prop="photo">
        <upload-imgs v-model:file-list="drawerProps.row!.photo" height="140px" width="140px" border-radius="50%">
          <template #empty>
